...
use crate::{bug_entity::components::{attribute_components::{PhysicalTraits, Vitals}, shared_components::{CurrentState, States}, ui_components::{CurrentStateText, EntityPanelRoot, HungerText, ThirstText}}, resources::CurrentlySelectedEntity};
