...
pub fn searching_new_state(mut query: Query<(Entity, &Transform, &mut FutureTransform, &PhysicalTraits), (With<Searching>, With<SearchingNew>, With<EntityRoot>)>, mut commands: Commands) {
